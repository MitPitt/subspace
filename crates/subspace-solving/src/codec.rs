...
// TODO: add this impl for `OpenClEncoder`
/// SAFETY: This is safe as long as all fields in `OpenClEncoder` are `Sync`
#[allow(unsafe_code)]
unsafe impl Sync for SubspaceCodec {}
// TODO: add this impl for `OpenClEncoder`
/// SAFETY: This is safe as long as all fields in `OpenClEncoder` are `Send`
#[allow(unsafe_code)]
unsafe impl Send for SubspaceCodec {}
